...
var TRANSLATIONS = {
  ...
  // Namenssuche (Dashboard und Schuelerauswahl beim Einplanen)
  weitereTreffer: { de:'… und {n} weitere — tippe weiter, um einzugrenzen', en:'… and {n} more — keep typing to narrow down', tr:'… ve {n} tane daha — daraltmak için yazmaya devam et', ar:'… و{n} أخرى — واصل الكتابة لتضييق النتائج', es:'… y {n} más — sigue escribiendo para acotar', fr:'… et {n} autres — continuez à taper pour affiner', pt:'… e {n} mais — continua a escrever para reduzir' },
  schuelerSuchenPlatzhalter: { de:'Schüler suchen — leer lassen für offenen Block', en:'Search student — leave empty for an open block', tr:'Öğrenci ara — boş bırakırsan açık blok olur', ar:'ابحث عن طالب — اتركه فارغاً لحجز مفتوح', es:'Buscar alumno — déjalo vacío para un bloque libre', fr:'Rechercher un élève — laissez vide pour un créneau libre', pt:'Procurar aluno — deixa vazio para um bloco livre' },
  // Mehrere Termine hintereinander einplanen (Maske bleibt offen)
  maskeBleibtOffen: { de:'Du kannst direkt den nächsten Termin einplanen — Datum oder Uhrzeit anpassen und wieder auf „Termin erstellen“ tippen.', en:'You can schedule the next appointment right away — adjust the date or time and tap “Create appointment” again.', tr:'Hemen sonraki randevuyu planlayabilirsin — tarihi veya saati değiştir ve tekrar „Randevu oluştur“a dokun.', ar:'يمكنك تحديد الموعد التالي فوراً — عدّل التاريخ أو الوقت واضغط «إنشاء موعد» مرة أخرى.', es:'Puedes programar la siguiente cita de inmediato: ajusta la fecha o la hora y vuelve a pulsar «Crear cita».', fr:'Vous pouvez planifier le rendez-vous suivant tout de suite : modifiez la date ou l’heure et appuyez à nouveau sur « Créer le rendez-vous ».', pt:'Podes marcar logo o próximo compromisso — ajusta a data ou a hora e toca outra vez em «Criar compromisso».' },
  bereitsErstellt: { de:'In dieser Maske erstellt', en:'Created in this dialog', tr:'Bu pencerede oluşturuldu', ar:'تم إنشاؤه في هذه النافذة', es:'Creado en este cuadro', fr:'Créé dans cette fenêtre', pt:'Criado nesta janela' },
  schliessenBtn: { de:'Schließen', en:'Close', tr:'Kapat', ar:'إغلاق', es:'Cerrar', fr:'Fermer', pt:'Fechar' },
  auswahlAufheben: { de:'Auswahl aufheben', en:'Clear selection', tr:'Seçimi kaldır', ar:'إلغاء الاختيار', es:'Quitar selección', fr:'Annuler la sélection', pt:'Remover seleção' },
  // Beitritt mit bestehendem Konto (z. B. Solo-Fahrlehrer wird uebernommen)
  beitretenTitel: { de:'Du hast schon ein FahrDoc-Konto', en:'You already have a FahrDoc account', tr:'Zaten bir FahrDoc hesabın var', ar:'لديك بالفعل حساب في FahrDoc', es:'Ya tienes una cuenta de FahrDoc', fr:'Vous avez déjà un compte FahrDoc', pt:'Já tens uma conta FahrDoc' },
  beitretenHinweis: { de:'Melde dich mit deinem bisherigen Passwort an, um der Fahrschule beizutreten. Du behältst dein Konto, und deine dokumentierten Fahrstunden bleiben erhalten.', en:'Sign in with your existing password to join the driving school. You keep your account, and your recorded lessons stay intact.', tr:'Sürücü kursuna katılmak için mevcut şifrenle giriş yap. Hesabın sende kalır ve kayıtlı derslerin korunur.', ar:'سجل الدخول بكلمة المرور الحالية للانضمام إلى مدرسة القيادة. تبقى لك نفس الحساب وتبقى دروسك الموثقة محفوظة.', es:'Inicia sesión con tu contraseña actual para unirte a la autoescuela. Conservas tu cuenta y tus clases documentadas se mantienen.', fr:'Connectez-vous avec votre mot de passe actuel pour rejoindre l\'auto-école. Vous conservez votre compte et vos leçons enregistrées.', pt:'Entra com a tua palavra-passe atual para te juntares à escola de condução. Manténs a tua conta e as aulas documentadas.' },
  fahrschuleBeitreten: { de:'Fahrschule beitreten', en:'Join driving school', tr:'Sürücü kursuna katıl', ar:'الانضمام إلى مدرسة القيادة', es:'Unirse a la autoescuela', fr:'Rejoindre l\'auto-école', pt:'Juntar-me à escola' },
  beigetreten: { de:'Willkommen! Du gehörst jetzt zur Fahrschule.', en:'Welcome! You are now part of the driving school.', tr:'Hoş geldin! Artık sürücü kursunun bir parçasısın.', ar:'مرحباً! أنت الآن ضمن مدرسة القيادة.', es:'¡Bienvenido! Ya formas parte de la autoescuela.', fr:'Bienvenue ! Vous faites désormais partie de l\'auto-école.', pt:'Bem-vindo! Agora fazes parte da escola.' },
  eigeneSchuelerFrage: { de:'Was soll mit deinen {n} eigenen Schülern passieren?', en:'What should happen to your {n} own students?', tr:'Kendi {n} öğrencine ne olsun?', ar:'ماذا تريد أن يحدث لطلابك الخاصين ({n})؟', es:'¿Qué debe pasar con tus {n} alumnos propios?', fr:'Que faire de vos {n} élèves personnels ?', pt:'O que deve acontecer aos teus {n} alunos próprios?' },
  eigeneSchuelerErklaerung: { de:'Übernimmst du sie, sieht {schule} sie im Schülerbestand und kann sie verwalten. Behältst du sie privat, bleiben sie nur in deinem Konto — richtig, wenn die Fahrschule dieselben Personen schon selbst führt.', en:'If you transfer them, {schule} sees them in its student list and can manage them. If you keep them private, they stay in your account only — the right choice if the school already has the same people on file.', tr:'Aktarırsan {schule} onları öğrenci listesinde görür ve yönetebilir. Özel tutarsan yalnızca senin hesabında kalırlar — kurs aynı kişileri zaten kayıtlı tutuyorsa doğru seçim budur.', ar:'إذا نقلتهم، فستراهم {schule} في قائمة الطلاب ويمكنها إدارتهم. وإذا أبقيتهم خاصين فسيبقون في حسابك وحدك — وهو الأنسب إن كانت المدرسة تحتفظ بنفس الأشخاص أصلاً.', es:'Si los transfieres, {schule} los verá en su lista de alumnos y podrá gestionarlos. Si los mantienes privados, se quedan solo en tu cuenta — lo correcto si la autoescuela ya tiene a las mismas personas registradas.', fr:'Si vous les transférez, {schule} les verra dans sa liste d\'élèves et pourra les gérer. Si vous les gardez privés, ils restent uniquement dans votre compte — le bon choix si l\'auto-école a déjà les mêmes personnes.', pt:'Se os transferires, {schule} vê-os na lista de alunos e pode gerí-los. Se os mantiveres privados, ficam apenas na tua conta — o correto se a escola já tem as mesmas pessoas registadas.' },
  schuelerPrivatBehalten: { de:'Privat behalten', en:'Keep private', tr:'Özel tut', ar:'الاحتفاظ بهم خاصين', es:'Mantener privados', fr:'Garder privés', pt:'Manter privados' },
  schuelerUebernehmen: { de:'In die Fahrschule übernehmen', en:'Transfer to the school', tr:'Kursa aktar', ar:'نقلهم إلى المدرسة', es:'Transferir a la autoescuela', fr:'Transférer à l\'auto-école', pt:'Transferir para a escola' },
  schuelerUebernommen: { de:'{n} Schüler in die Fahrschule übernommen', en:'{n} students transferred to the school', tr:'{n} öğrenci kursa aktarıldı', ar:'تم نقل {n} طالباً إلى المدرسة', es:'{n} alumnos transferidos a la autoescuela', fr:'{n} élèves transférés à l\'auto-école', pt:'{n} alunos transferidos para a escola' },
  schuelerPrivatGeblieben: { de:'Deine {n} Schüler bleiben privat', en:'Your {n} students stay private', tr:'{n} öğrencin özel kalıyor', ar:'طلابك ({n}) يبقون خاصين', es:'Tus {n} alumnos siguen siendo privados', fr:'Vos {n} élèves restent privés', pt:'Os teus {n} alunos ficam privados' },
  empfohlen: { de:'empfohlen', en:'recommended', tr:'önerilir', ar:'موصى به', es:'recomendado', fr:'recommandé', pt:'recomendado' },
  ...
  // ── Unterbrochene Fahrstunde wiederherstellen ──
  unterbrocheneStunde:      { de:'Unterbrochene Fahrstunde', en:'Interrupted lesson', tr:'Yarıda kalan ders', ar:'درس متوقف', es:'Clase interrumpida', fr:'Leçon interrompue', pt:'Aula interrompida' },
  unterbrocheneStundeText:  { de:'Diese Fahrstunde wurde nicht beendet — die App wurde zwischendurch geschlossen.', en:'This lesson was never finished — the app was closed in between.', tr:'Bu ders tamamlanmadı — uygulama arada kapandı.', ar:'لم يتم إنهاء هذا الدرس — أُغلق التطبيق في الأثناء.', es:'Esta clase no se finalizó: la aplicación se cerró mientras tanto.', fr:'Cette leçon n’a pas été terminée — l’application s’est fermée entre-temps.', pt:'Esta aula não foi concluída — a aplicação fechou entretanto.' },
  unterbrocheneStundeHinweis:{ de:'Beim Fortsetzen laufen Zeit, Strecke und Markierungen weiter. Fotos aus der unterbrochenen Stunde sind nicht gespeichert.', en:'Resuming keeps the time, route and markers. Photos from the interrupted lesson were not saved.', tr:'Devam ettiğinizde süre, güzergâh ve işaretler korunur. Yarıda kalan dersin fotoğrafları kaydedilmedi.', ar:'عند المتابعة يبقى الوقت والمسار والعلامات. صور الدرس المتوقف لم يتم حفظها.', es:'Al continuar se mantienen el tiempo, la ruta y las marcas. Las fotos de la clase interrumpida no se guardaron.', fr:'En reprenant, le temps, l’itinéraire et les repères sont conservés. Les photos de la leçon interrompue n’ont pas été enregistrées.', pt:'Ao continuar, mantêm-se o tempo, o percurso e as marcações. As fotos da aula interrompida não foram guardadas.' },
  begonnenUm:               { de:'Begonnen um', en:'Started at', tr:'Başlangıç', ar:'بدأ في', es:'Iniciada a las', fr:'Commencée à', pt:'Iniciada às' },
  bisherigeDauer:           { de:'Bisherige Dauer', en:'Elapsed so far', tr:'Şu ana kadar', ar:'المدة حتى الآن', es:'Duración hasta ahora', fr:'Durée écoulée', pt:'Duração até agora' },
  stundeFortsetzen:         { de:'Fahrstunde fortsetzen', en:'Resume lesson', tr:'Derse devam et', ar:'متابعة الدرس', es:'Continuar la clase', fr:'Reprendre la leçon', pt:'Continuar a aula' },
  verwerfen:                { de:'Verwerfen', en:'Discard', tr:'Sil', ar:'تجاهل', es:'Descartar', fr:'Abandonner', pt:'Descartar' },
  entwurfVerworfen:         { de:'Unterbrochene Fahrstunde verworfen', en:'Interrupted lesson discarded', tr:'Yarıda kalan ders silindi', ar:'تم تجاهل الدرس المتوقف', es:'Clase interrumpida descartada', fr:'Leçon interrompue abandonnée', pt:'Aula interrompida descartada' },
  entwurfNichtMehrDa:       { de:'Die unterbrochene Fahrstunde ist nicht mehr verfügbar', en:'The interrupted lesson is no longer available', tr:'Yarıda kalan ders artık mevcut değil', ar:'الدرس المتوقف لم يعد متاحاً', es:'La clase interrumpida ya no está disponible', fr:'La leçon interrompue n’est plus disponible', pt:'A aula interrompida já não está disponível' },
  stundeWiederhergestellt:  { de:'Fahrstunde wiederhergestellt', en:'Lesson restored', tr:'Ders geri yüklendi', ar:'تمت استعادة الدرس', es:'Clase restaurada', fr:'Leçon restaurée', pt:'Aula restaurada' },
  minKurz:                  { de:'Min.', en:'min', tr:'dk.', ar:'د', es:'min', fr:'min', pt:'min' },
  uhr:                      { de:'Uhr', en:'', tr:'', ar:'', es:'h', fr:'', pt:'' },
  art:                      { de:'Art', en:'Type', tr:'Tür', ar:'النوع', es:'Tipo', fr:'Type', pt:'Tipo' },
  ...
  neuesPasswort: { de:'Neues Passwort', en:'New password', tr:'Yeni şifre', ar:'كلمة مرور جديدة', es:'Nueva contraseña', fr:'Nouveau mot de passe', pt:'Nova palavra-passe' },
  neuesPasswortBestaetigen: { de:'Neues Passwort bestätigen', en:'Confirm new password' },
  passwortGeaendert: { de:'Passwort erfolgreich geändert', en:'Password changed successfully', tr:'Şifre başarıyla değiştirildi', ar:'تم تغيير كلمة المرور بنجاح', es:'Contraseña cambiada correctamente', fr:'Mot de passe modifié avec succès', pt:'Palavra-passe alterada com sucesso' },
  passwortFalsch: { de:'Aktuelles Passwort ist falsch', en:'Current password is incorrect' },
  passwortZuKurz: { de:'Passwort muss mindestens 6 Zeichen haben', en:'Password must be at least 6 characters', tr:'Şifre en az 6 karakter olmalı', ar:'يجب أن تتكون كلمة المرور من 6 أحرف على الأقل', es:'La contraseña debe tener al menos 6 caracteres', fr:'Le mot de passe doit comporter au moins 6 caractères', pt:'A palavra-passe deve ter pelo menos 6 caracteres' },

  // ---- Passwort vergessen (Ablauf ueber Link aus der E-Mail) ----
  passwortVergessen: { de:'Passwort vergessen?', en:'Forgot password?', tr:'Şifrenizi mi unuttunuz?', ar:'نسيت كلمة المرور؟', es:'¿Olvidaste tu contraseña?', fr:'Mot de passe oublié ?', pt:'Esqueceu a palavra-passe?' },
  passwortVergessenTitel: { de:'Passwort vergessen', en:'Forgot password', tr:'Şifremi unuttum', ar:'نسيت كلمة المرور', es:'Contraseña olvidada', fr:'Mot de passe oublié', pt:'Palavra-passe esquecida' },
  passwortVergessenText: { de:'Gib deine E-Mail-Adresse ein. Wir senden dir einen Link, mit dem du ein neues Passwort festlegen kannst.', en:'Enter your email address. We will send you a link to set a new password.', tr:'E-posta adresinizi girin. Yeni bir şifre belirlemeniz için size bir bağlantı göndereceğiz.', ar:'أدخل بريدك الإلكتروني. سنرسل لك رابطًا لتعيين كلمة مرور جديدة.', es:'Introduce tu dirección de correo. Te enviaremos un enlace para establecer una nueva contraseña.', fr:'Saisis ton adresse e-mail. Nous t’enverrons un lien pour définir un nouveau mot de passe.', pt:'Introduz o teu e-mail. Enviaremos um link para definires uma nova palavra-passe.' },
  linkSenden: { de:'Link senden', en:'Send link', tr:'Bağlantı gönder', ar:'إرسال الرابط', es:'Enviar enlace', fr:'Envoyer le lien', pt:'Enviar link' },
  erneutSenden: { de:'Erneut senden', en:'Send again', tr:'Tekrar gönder', ar:'إرسال مرة أخرى', es:'Enviar de nuevo', fr:'Envoyer à nouveau', pt:'Enviar novamente' },
  wirdGesendet: { de:'Wird gesendet…', en:'Sending…', tr:'Gönderiliyor…', ar:'جارٍ الإرسال…', es:'Enviando…', fr:'Envoi…', pt:'A enviar…' },
  linkGesendetText: { de:'Falls ein Konto mit dieser Adresse existiert, haben wir dir gerade einen Link geschickt. Bitte schau auch im Spam-Ordner. Der Link ist 60 Minuten gültig.', en:'If an account exists for this address, we have just sent you a link. Please also check your spam folder. The link is valid for 60 minutes.', tr:'Bu adrese ait bir hesap varsa, size bir bağlantı gönderdik. Lütfen spam klasörünü de kontrol edin. Bağlantı 60 dakika geçerlidir.', ar:'إن وجد حساب بهذا العنوان، فقد أرسلنا لك رابطًا الآن. يرجى التحقق من مجلد البريد غير المرغوب أيضًا. الرابط صالح لمدة 60 دقيقة.', es:'Si existe una cuenta con esta dirección, acabamos de enviarte un enlace. Revisa también la carpeta de spam. El enlace es válido durante 60 minutos.', fr:'Si un compte existe pour cette adresse, nous venons de t’envoyer un lien. Vérifie aussi ton dossier spam. Le lien est valable 60 minutes.', pt:'Se existir uma conta com este endereço, acabámos de te enviar um link. Verifica também a pasta de spam. O link é válido durante 60 minutos.' },
  emailUngueltig: { de:'Bitte gib eine gültige E-Mail-Adresse ein', en:'Please enter a valid email address', tr:'Lütfen geçerli bir e-posta adresi girin', ar:'الرجاء إدخال بريد إلكتروني صالح', es:'Introduce una dirección de correo válida', fr:'Saisis une adresse e-mail valide', pt:'Introduz um endereço de e-mail válido' },
  fehlerBeimSenden: { de:'Senden fehlgeschlagen', en:'Sending failed', tr:'Gönderme başarısız', ar:'فشل الإرسال', es:'Error al enviar', fr:'Échec de l’envoi', pt:'Falha no envio' },
  zurueckZurAnmeldung: { de:'Zurück zur Anmeldung', en:'Back to sign in', tr:'Girişe dön', ar:'العودة إلى تسجيل الدخول', es:'Volver al inicio de sesión', fr:'Retour à la connexion', pt:'Voltar ao início de sessão' },
  neuesPasswortTitel: { de:'Neues Passwort', en:'New password', tr:'Yeni şifre', ar:'كلمة مرور جديدة', es:'Nueva contraseña', fr:'Nouveau mot de passe', pt:'Nova palavra-passe' },
  neuesPasswortText: { de:'Lege jetzt ein neues Passwort für dein Konto fest.', en:'Set a new password for your account now.', tr:'Şimdi hesabınız için yeni bir şifre belirleyin.', ar:'عيّن الآن كلمة مرور جديدة لحسابك.', es:'Establece ahora una nueva contraseña para tu cuenta.', fr:'Définis maintenant un nouveau mot de passe pour ton compte.', pt:'Define agora uma nova palavra-passe para a tua conta.' },
  neuesPasswortFuer: { de:'Neues Passwort für', en:'New password for', tr:'Şu hesap için yeni şifre:', ar:'كلمة مرور جديدة لـ', es:'Nueva contraseña para', fr:'Nouveau mot de passe pour', pt:'Nova palavra-passe para' },
  mindestens6Zeichen: { de:'Mindestens 6 Zeichen', en:'At least 6 characters', tr:'En az 6 karakter', ar:'6 أحرف على الأقل', es:'Al menos 6 caracteres', fr:'Au moins 6 caractères', pt:'Pelo menos 6 caracteres' },
  passwortWiederholen: { de:'Passwort wiederholen', en:'Repeat password', tr:'Şifreyi yineleyin', ar:'أعد إدخال كلمة المرور', es:'Repetir contraseña', fr:'Répéter le mot de passe', pt:'Repetir palavra-passe' },
  passwortSpeichern: { de:'Passwort speichern', en:'Save password', tr:'Şifreyi kaydet', ar:'حفظ كلمة المرور', es:'Guardar contraseña', fr:'Enregistrer le mot de passe', pt:'Guardar palavra-passe' },
  speichereEllipse: { de:'Speichere…', en:'Saving…', tr:'Kaydediliyor…', ar:'جارٍ الحفظ…', es:'Guardando…', fr:'Enregistrement…', pt:'A guardar…' },
  speichernFehlgeschlagen: { de:'Speichern fehlgeschlagen', en:'Saving failed', tr:'Kaydetme başarısız', ar:'فشل الحفظ', es:'Error al guardar', fr:'Échec de l’enregistrement', pt:'Falha ao guardar' },
  passwoerterUngleich: { de:'Die Passwörter stimmen nicht überein', en:'The passwords do not match', tr:'Şifreler birbiriyle uyuşmuyor', ar:'كلمتا المرور غير متطابقتين', es:'Las contraseñas no coinciden', fr:'Les mots de passe ne correspondent pas', pt:'As palavras-passe não coincidem' },
  resetLinkUngueltig: { de:'Dieser Link ist ungültig, abgelaufen oder wurde bereits verwendet. Fordere einen neuen an.', en:'This link is invalid, expired or has already been used. Please request a new one.', tr:'Bu bağlantı geçersiz, süresi dolmuş veya zaten kullanılmış. Lütfen yeni bir tane isteyin.', ar:'هذا الرابط غير صالح أو منتهٍ أو استُخدم من قبل. يرجى طلب رابط جديد.', es:'Este enlace no es válido, ha caducado o ya se ha usado. Solicita uno nuevo.', fr:'Ce lien est invalide, expiré ou déjà utilisé. Demande un nouveau lien.', pt:'Este link é inválido, expirou ou já foi utilizado. Solicita um novo.' },
  ...
  terminVerschoben: { de:'Verschoben: {ziel}', en:'Moved: {ziel}', tr:'Taşındı: {ziel}', ar:'تم النقل: {ziel}', es:'Movido: {ziel}', fr:'Déplacé : {ziel}', pt:'Movido: {ziel}' },
  verschiebenZurueckgenommen: { de:'Verschieben zurückgenommen', en:'Move undone', tr:'Taşıma geri alındı', ar:'تم التراجع عن النقل', es:'Movimiento deshecho', fr:'Déplacement annulé', pt:'Movimento desfeito' },
  verschiebenFehlgeschlagen: { de:'Verschieben nicht möglich', en:'Could not move appointment', tr:'Taşıma mümkün değil', ar:'لا يمكن نقل الموعد', es:'No se pudo mover', fr:'Déplacement impossible', pt:'Não foi possível mover' },
  ueberschneidungMitTermin: { de:'Überschneidung mit einem Termin um {zeit}', en:'Overlaps with an appointment at {zeit}', tr:'{zeit} saatindeki randevuyla çakışıyor', ar:'تعارض مع موعد في {zeit}', es:'Se solapa con una cita a las {zeit}', fr:'Chevauchement avec un rendez-vous à {zeit}', pt:'Sobreposição com um compromisso às {zeit}' },
  doppelbelegungBestaetigen: { de:'{grund}.\n\nZwei Termine zur selben Zeit werden nebeneinander angezeigt. Trotzdem einplanen?', en:'{grund}.\n\nTwo appointments at the same time are shown side by side. Schedule anyway?', tr:'{grund}.\n\nAynı saatteki iki randevu yan yana gösterilir. Yine de planlanacak mı?', ar:'{grund}.\n\nيُعرض موعدان في الوقت نفسه جنبًا إلى جنب. هل تريد الجدولة على أي حال؟', es:'{grund}.\n\nDos citas a la misma hora se muestran una al lado de la otra. ¿Programar de todos modos?', fr:'{grund}.\n\nDeux rendez-vous à la même heure s’affichent côte à côte. Planifier quand même ?', pt:'{grund}.\n\nDois compromissos à mesma hora aparecem lado a lado. Agendar mesmo assim?' },
  vorherigeWoche: { de:'Vorherige Woche', en:'Previous week', tr:'Önceki hafta', ar:'الأسبوع السابق', es:'Semana anterior', fr:'Semaine précédente', pt:'Semana anterior' },
  naechsteWoche: { de:'Nächste Woche', en:'Next week', tr:'Sonraki hafta', ar:'الأسبوع التالي', es:'Semana siguiente', fr:'Semaine suivante', pt:'Próxima semana' },
  monatWaehlen: { de:'Monat wählen', en:'Choose month', tr:'Ay seçin', ar:'اختر الشهر', es:'Elegir mes', fr:'Choisir le mois', pt:'Escolher mês' },
  heuteAnzeigen: { de:'Heute', en:'Today', tr:'Bugün', ar:'اليوم', es:'Hoy', fr:'Aujourd’hui', pt:'Hoje' },
  standarddauerUebungsfahrt: { de:'Standarddauer Übungsfahrt (Minuten)', en:'Default duration of a practice drive (minutes)', tr:'Standart alıştırma sürüşü süresi (dakika)', ar:'المدة الافتراضية لجولة التدريب (بالدقائق)', es:'Duración estándar de la clase práctica (minutos)', fr:'Durée par défaut d’une leçon de conduite (minutes)', pt:'Duração padrão da aula prática (minutos)' },
  terminplanungEinstellungen: { de:'Terminplanung', en:'Scheduling', tr:'Randevu planlama', ar:'تخطيط المواعيد', es:'Planificación de citas', fr:'Planification', pt:'Planeamento de compromissos' },
  standarddauerHinweis: { de:'Wird beim Einplanen einer Übungsfahrt als Endzeit vorgeschlagen. Leer lassen für 90 Minuten.', en:'Used to pre-fill the end time when scheduling a practice drive. Leave empty for 90 minutes.', tr:'Alıştırma sürüşü planlanırken bitiş saati olarak önerilir. 90 dakika için boş bırakın.', ar:'يُستخدم لتعبئة وقت الانتهاء عند جدولة جولة تدريب. اتركه فارغًا لـ 90 دقيقة.', es:'Se usa para proponer la hora de fin al programar una clase práctica. Déjalo vacío para 90 minutos.', fr:'Sert à proposer l’heure de fin lors de la planification. Laisser vide pour 90 minutes.', pt:'Usado para propor a hora de fim ao agendar uma aula prática. Deixe vazio para 90 minutos.' },
  rueckgaengig: { de:'Rückgängig', en:'Undo', tr:'Geri al', ar:'تراجع', es:'Deshacer', fr:'Annuler', pt:'Desfazer' },
  ziehenZumVerschieben: { de:'Termin ziehen, um ihn zu verschieben \u00b7 am Handy lang dr\u00fccken', en:'Drag an appointment to move it \u00b7 on mobile press and hold', tr:'Taşımak için randevuyu sürükleyin \u00b7 telefonda basılı tutun', ar:'اسحب الموعد لنقله \u00b7 على الهاتف اضغط مع الاستمرار', es:'Arrastra una cita para moverla \u00b7 en el móvil mantén pulsado', fr:'Faites glisser un rendez-vous pour le déplacer \u00b7 sur mobile, appui long', pt:'Arraste um compromisso para o mover \u00b7 no telemóvel, toque e mantenha' },
  ...
  namenSuchen: { de:'Namen suchen …', en:'Search name …', tr:'İsim ara …', ar:'ابحث عن الاسم …', es:'Buscar nombre …', fr:'Rechercher un nom …', pt:'Pesquisar nome …' },
  keineTreffer: { de:'Keine Treffer', en:'No matches', tr:'Sonuç yok', ar:'لا نتائج', es:'Sin resultados', fr:'Aucun résultat', pt:'Nenhum resultado' },
  alle: { de:'Alle', en:'All', tr:'Tümü', ar:'الكل', es:'Todos', fr:'Tous', pt:'Todos' },
  ...
  b196BescheinigungHinweis: { de:'Teilnahmebescheinigung nach Anlage 7b Nr. 6 FeV zur Vorlage bei der Fahrerlaubnisbeh\u00f6rde (Eintragung der Schl\u00fcsselzahl 196).', en:'Participation certificate under Annex 7b No. 6 FeV for submission to the licensing authority (key code 196).', tr:'Ehliyet dairesine sunulmak \u00fczere B196 kat\u0131l\u0131m belgesi.', ar:'\u0634\u0647\u0627\u062f\u0629 \u0645\u0634\u0627\u0631\u0643\u0629 B196 \u0644\u062a\u0642\u062f\u064a\u0645\u0647\u0627 \u0644\u0644\u0633\u0644\u0637\u0629 \u0627\u0644\u0645\u062e\u062a\u0635\u0629.', es:'Certificado de participaci\u00f3n B196 para presentar ante la autoridad.', fr:'Attestation de participation B196 \u00e0 pr\u00e9senter \u00e0 l\u2019autorit\u00e9.', pt:'Certificado de participa\u00e7\u00e3o B196 para apresentar \u00e0 autoridade.' },
  b196Dokumentation: { de:'B196 Dokumentation der Fahrerschulung', en:'B196 Training Documentation', tr:'B196 E\u011fitim Dok\u00fcmantasyonu', ar:'\u0648\u0631\u0642\u0629 \u062a\u0648\u062b\u064a\u0642 \u062a\u062f\u0631\u064a\u0628 B196', es:'Documentaci\u00f3n de la formaci\u00f3n B196', fr:'Documentation de la formation B196', pt:'Documenta\u00e7\u00e3o da forma\u00e7\u00e3o B196' },
  b196DokumentationHinweis: { de:'Interner Nachweis der durchgef\u00fchrten Theorie- und Praxiseinheiten (Anlage 7b FeV). Bleibt in den Unterlagen der Fahrschule.', en:'Internal record of completed theory and practical units (Annex 7b FeV). Stays in the driving school\u2019s files.', tr:'Yap\u0131lan teori ve direksiyon saatlerinin dahili kayd\u0131.', ar:'\u0633\u062c\u0644 \u062f\u0627\u062e\u0644\u064a \u0644\u0644\u062d\u0635\u0635 \u0627\u0644\u0646\u0637\u0631\u064a\u0629 \u0648\u0627\u0644\u0639\u0645\u0644\u064a\u0629.', es:'Registro interno de las unidades de teor\u00eda y pr\u00e1ctica realizadas.', fr:'Registre interne des unit\u00e9s de th\u00e9orie et de pratique effectu\u00e9es.', pt:'Registro interno das unidades de teoria e pr\u00e1tica realizadas.' },
  b196Kompetenz: { de:'B196 Feststellung der Fahrkompetenz', en:'B196 Driving Competence Assessment', tr:'B196 S\u00fcr\u00fc\u015f yeterlili\u011fi tespiti', ar:'\u062a\u0642\u064a\u064a\u0645 \u0627\u0644\u0643\u0641\u0627\u0621\u0629 \u0627\u0644\u0642\u064a\u0627\u062f\u064a\u0629 B196', es:'Evaluaci\u00f3n de la competencia de conducci\u00f3n B196', fr:'\u00c9valuation de la comp\u00e9tence de conduite B196', pt:'Avalia\u00e7\u00e3o da compet\u00eancia de condu\u00e7\u00e3o B196' },
  b196KompetenzHinweis: { de:'Bewertungsbogen nach Anlage 7b FeV: Grundfahraufgaben, Fahren innerhalb von Ortschaften sowie Landstra\u00dfe und Autobahn.', en:'Assessment sheet under Annex 7b FeV: basic manoeuvres, urban driving, rural roads and motorway.', tr:'Anlage 7b FeV kapsam\u0131nda de\u011ferlendirme formu.', ar:'\u0646\u0645\u0648\u0630\u062c \u062a\u0642\u064a\u064a\u0645 \u0648\u0641\u0642 \u0627\u0644\u0645\u0644\u062d\u0642 7b.', es:'Hoja de evaluaci\u00f3n seg\u00fan el anexo 7b FeV.', fr:'Fiche d\u2019\u00e9valuation selon l\u2019annexe 7b FeV.', pt:'Folha de avalia\u00e7\u00e3o conforme o anexo 7b FeV.' },
  b196KompetenzKreuzeHinweis: { de:'Hinweis: Die Spalten \u201eNein\u201c und \u201eJa\u201c bleiben im PDF leer und werden vom Fahrlehrer w\u00e4hrend der Fahrt angekreuzt. Alle Felder sind optional.', en:'Note: the \u201cNo\u201d and \u201cYes\u201d columns stay empty and are ticked by the instructor. All fields are optional.', tr:'Not: \u201eHay\u0131r\u201c ve \u201eEvet\u201c kolonlar\u0131 bo\u015f kal\u0131r.', ar:'\u0645\u0644\u0627\u062d\u0632\u0629: \u062a\u0628\u0642\u0649 \u062e\u0627\u0646\u0627\u062a \u0646\u0639\u0645/\u0644\u0627 \u0641\u0627\u0631\u063a\u0629.', es:'Nota: las columnas \u201cNo\u201d y \u201cS\u00ed\u201d quedan vac\u00edas.', fr:'Remarque : les colonnes \u00ab Non \u00bb et \u00ab Oui \u00bb restent vides.', pt:'Nota: as colunas \u201cN\u00e3o\u201d e \u201cSim\u201d ficam vazias.' },
  hersteller: { de:'Hersteller', en:'Manufacturer', tr:'\u0130malat\u00e7\u0131', ar:'\u0627\u0644\u0645\u0635\u0646\u0639', es:'Fabricante', fr:'Constructeur', pt:'Fabricante' },
  typBezeichnung: { de:'Typ', en:'Model', tr:'Tip', ar:'\u0627\u0644\u0637\u0631\u0627\u0632', es:'Modelo', fr:'Type', pt:'Modelo' },
  getriebeart: { de:'Getriebeart', en:'Transmission', tr:'\u015eanz\u0131man t\u00fcr\u00fc', ar:'\u0646\u0648\u0639 \u0646\u0627\u0642\u0644 \u0627\u0644\u062d\u0631\u0643\u0629', es:'Tipo de cambio', fr:'Bo\u00eete de vitesses', pt:'Tipo de c\u00e2mbio' },
  schaltgetriebe: { de:'Schaltgetriebe', en:'Manual', tr:'Manuel', ar:'\u064a\u062f\u0648\u064a', es:'Manual', fr:'Manuelle', pt:'Manual' },
  b196Gruppe: { de:'B196 (Leichtkraftrad)', en:'B196 (light motorcycle)', tr:'B196 (hafif motosiklet)', ar:'B196 (\u062f\u0631\u0627\u062c\u0629 \u062e\u0641\u064a\u0641\u0629)', es:'B196 (motocicleta ligera)', fr:'B196 (motocyclette l\u00e9g\u00e8re)', pt:'B196 (motocicleta leve)' },
  strasseHausnummer: { de:'Stra\u00dfe, Hausnummer', en:'Street, house number', tr:'Sokak, kap\u0131 no', ar:'\u0627\u0644\u0634\u0627\u0631\u0639 \u0648\u0631\u0642\u0645 \u0627\u0644\u0645\u0646\u0632\u0644', es:'Calle, n\u00famero', fr:'Rue, num\u00e9ro', pt:'Rua, n\u00famero' },
  plzOrt: { de:'PLZ, Ort', en:'Postal code, city', tr:'Posta kodu, \u015fehir', ar:'\u0627\u0644\u0631\u0645\u0632 \u0627\u0644\u0628\u0631\u064a\u062f\u064a \u0648\u0627\u0644\u0645\u062f\u064a\u0646\u0629', es:'C\u00f3digo postal, ciudad', fr:'Code postal, ville', pt:'C\u00f3digo postal, cidade' },
  schulungVon: { de:'Fahrerschulung vom', en:'Training from', tr:'E\u011fitim ba\u015flang\u0131c\u0131', ar:'\u0627\u0644\u062a\u062f\u0631\u064a\u0628 \u0645\u0646', es:'Formaci\u00f3n desde', fr:'Formation du', pt:'Forma\u00e7\u00e3o de' },
  schulungBis: { de:'bis', en:'until', tr:'biti\u015f', ar:'\u0625\u0644\u0649', es:'hasta', fr:'au', pt:'at\u00e9' },
  fuehrerscheinnummer: { de:'F\u00fchrerscheinnummer', en:'Driving licence number', tr:'Ehliyet numaras\u0131', ar:'\u0631\u0642\u0645 \u0631\u062e\u0635\u0629 \u0627\u0644\u0642\u064a\u0627\u062f\u0629', es:'N\u00famero de permiso', fr:'Num\u00e9ro de permis', pt:'N\u00famero da carta' },
  ortAusstellung: { de:'Ort (Ausstellung)', en:'Place of issue', tr:'D\u00fczenlenme yeri', ar:'\u0645\u0643\u0627\u0646 \u0627\u0644\u0625\u0635\u062f\u0627\u0631', es:'Lugar de emisi\u00f3n', fr:'Lieu de d\u00e9livrance', pt:'Local de emiss\u00e3o' },
  ausgehaendigtAm: { de:'Ausgeh\u00e4ndigt am', en:'Handed over on', tr:'Teslim tarihi', ar:'\u062a\u0627\u0631\u064a\u062e \u0627\u0644\u062a\u0633\u0644\u064a\u0645', es:'Entregado el', fr:'Remis le', pt:'Entregue em' },
