...
var TRANSLATIONS = {
  ...
  // PDF-Bericht Strings
  pdfTitel:            { de:'Fahrstunden-Bericht', en:'Driving Lesson Report', tr:'Sürüş Dersi Raporu', ar:'Driving Lesson Report', es:'Informe de clase de conducir', fr:'Rapport de leçon de conduite' },
  pdfRoute:            { de:'Route', en:'Route', tr:'Rota', ar:'Route', es:'Ruta', fr:'Itinéraire' },
  pdfTempo:            { de:'\u00d8 Tempo', en:'\u00d8 Speed', tr:'\u00d8 H\u0131z', ar:'\u00d8 Speed', es:'\u00d8 Velocidad', fr:'\u00d8 Vitesse' },
  pdfMarkierung:       { de:'Markierung', en:'Marker', tr:'\u0130\u015faret', ar:'Marker', es:'Marcador', fr:'Rep\u00e8re' },
  pdfInKarteOeffnen:   { de:'In Karte \u00f6ffnen \u203a', en:'Open in map \u203a', tr:'Haritada a\u00e7 \u203a', ar:'Open in map \u203a', es:'Abrir en el mapa \u203a', fr:'Ouvrir dans la carte \u203a' },
  pdfSeite:            { de:'Seite', en:'Page', tr:'Sayfa', ar:'Page', es:'P\u00e1gina', fr:'Page' },
  pdfErstelltMit:      { de:'Erstellt mit', en:'Created with', tr:'Olu\u015fturuldu', ar:'Created with', es:'Creado con', fr:'Cr\u00e9\u00e9 avec' },
  pdfSehrGut:          { de:'Sehr gut', en:'Excellent', tr:'\u00c7ok iyi', ar:'Excellent', es:'Excelente', fr:'Tr\u00e8s bien' },
  pdfGut:              { de:'Gut', en:'Good', tr:'\u0130yi', ar:'Good', es:'Bien', fr:'Bien' },
  pdfAusreichend:      { de:'Ausreichend', en:'Sufficient', tr:'Yeterli', ar:'Sufficient', es:'Suficiente', fr:'Suffisant' },
  pdfUngenuegend:      { de:'Ungen\u00fcgend', en:'Insufficient', tr:'Yetersiz', ar:'Insufficient', es:'Insuficiente', fr:'Insuffisant' },
  pdfBeobachtungskategorien:{ de:'Beobachtungskategorien', en:'Observation categories', tr:'G\u00f6zlem kategorileri', ar:'Observation categories', es:'Categor\u00edas de observaci\u00f3n', fr:'Cat\u00e9gories d\u2019observation' },
  pdfFahraufgaben:     { de:'Fahraufgaben im Stra\u00dfenverkehr', en:'Road driving tasks', tr:'Trafikte s\u00fcr\u00fc\u015f g\u00f6revleri', ar:'Road driving tasks', es:'Tareas de conducci\u00f3n vial', fr:'T\u00e2ches de conduite' },
  pdfGrundfahraufgaben:{ de:'Grundfahraufgaben', en:'Basic driving tasks', tr:'Temel s\u00fcr\u00fc\u015f g\u00f6revleri', ar:'Basic driving tasks', es:'Tareas b\u00e1sicas de conducci\u00f3n', fr:'T\u00e2ches de base' },
  pdfDateiName:        { de:'Fahrstunde', en:'Lesson', tr:'Ders', ar:'Lesson', es:'Clase', fr:'Lecon' },
  pdfStudent:          { de:'Schueler', en:'Student', tr:'Ogrenci', ar:'Student', es:'Alumno', fr:'Eleve' },
  pdfFahrlehrer:       { de:'Fahrlehrer', en:'Instructor', tr:'E\u011fitmen', ar:'Instructor', es:'Instructor', fr:'Moniteur' },
