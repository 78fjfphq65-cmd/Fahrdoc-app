...
var TRANSLATIONS = {
  ...
  themenAbsolviert: { de:'{x}/{y} Themen absolviert', en:'{x}/{y} Topics completed', tr:'{x}/{y} Konu tamamlandı', ar:'{x}/{y} مواضيع مكتملة', es:'{x}/{y} Temas completados', fr:'{x}/{y} Sujets terminés' },
